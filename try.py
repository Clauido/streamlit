...
df = pd.read_csv(
    "./UNI_CORR_500_01.txt", skiprows=3, sep="\t").rename(columns={"# PersID": "PersID"})
...
# Desplegamos un histograma con los
...
with st.sidebar:
    ...
    st.write("# Opciones")
    # slider
    div = st.slider('Número debins:', 0, 130, 25)
    st.write("Bins=", div)
...
ax[1].set_title('Histograma posiciónes en eleje Y')
